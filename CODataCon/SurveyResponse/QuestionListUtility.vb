...
<Serializable()> Public Class QuestionListUtility
    ...
    Public Shared Function FindQuestionByQuestionGroupID(ByVal QuestionGroupID As Integer, ByRef ql As List(Of QuestionItem)) As List(Of QuestionItem)
        ...
        End Try
    End Function
    Shared Function FindQuestionByQuestionGroupID(reqQuestionGroupID As Integer, questionItem As QuestionItem()) As List(Of QuestionItem)
        Try
            Return (From i In questionItem Where i.QuestionGroupMember.QuestionGroupID = reqQuestionGroupID).ToList
        Catch ex As Exception
            Return New List(Of QuestionItem)
        End Try
    End Function
