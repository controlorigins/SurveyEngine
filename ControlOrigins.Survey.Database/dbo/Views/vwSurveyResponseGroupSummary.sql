CREATE VIEW [dbo].[vwSurveyResponseGroupSummary]
AS
SELECT        dbo.SurveyResponse.SurveyResponseID, dbo.SurveyResponse.SurveyResponseNM, dbo.SurveyResponse.SurveyID, dbo.SurveyResponse.ApplicationID, dbo.SurveyResponse.AssignedUserID, 
                         ...
                         AVG(dbo.Question.QuestionValue * dbo.QuestionAnswer.QuestionAnswerValue) AS AverageQuestionScore, dbo.QuestionGroup.QuestionGroupID, dbo.QuestionGroup.GroupOrder, 
