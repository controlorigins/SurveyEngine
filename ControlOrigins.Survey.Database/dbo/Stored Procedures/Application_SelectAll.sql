...
-- ==========================================================================================
-- Entity Name:	Application_SelectAll
-- Author:	Mark Hazleton
-- Create date:	9/21/2015 8:43:54 AM
-- Description:	This stored procedure is intended for selecting all rows from Application table
-- ==========================================================================================
CREATE Procedure [dbo].[Application_SelectAll]
As
Begin
