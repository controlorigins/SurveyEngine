...
-- ==========================================================================================
-- Entity Name:	Question_SelectRow
-- Create date:	10/16/2015 12:12:44 PM
-- Description:	This stored procedure is intended for selecting a specific row from Question table
-- ==========================================================================================
CREATE Procedure [dbo].[Question_SelectRow]
	@QuestionID int
As
Begin
