...
-- ==========================================================================================
-- Entity Name:	lu_SurveyType_SelectAll
-- Create date:	10/5/2015 12:13:50 PM
-- Description:	This stored procedure is intended for selecting all rows from lu_SurveyType table
-- ==========================================================================================
CREATE Procedure [dbo].[lu_SurveyType_SelectAll]
As
Begin
