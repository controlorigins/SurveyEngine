...
Public Class SurveyResponseQuestionForm
    Property Question As QuestionItem
    Property CurrentResponseList As New List(Of SurveyResponseAnswerItem)
    Property SurveyResponseID As Integer
    Property QuestionIndex As Integer
    Property curSurveyResponseAnswer As SurveyResponseAnswerItem
    ...
    Public Function GetQuestionAnswerForm(ByVal SequenceNumber As Integer, bAddDiv As Boolean, ByVal myTabIndex As Integer) As String
        ...
        Else
            curSurveyResponseAnswer = New SurveyResponseAnswerItem
        End If
        If bAddDiv Then
        ...
        Select Case Question.QuestionTypeCD
            ...
            Case "COM"
                sForm.Append(GetMemoInput(SurveyResponseItemBL.GetQuestionName(SurveyResponseID, SequenceNumber, Question), SurveyResponseItemBL.GetQuestionName(SurveyResponseID, SequenceNumber, Question), curSurveyResponseAnswer.AnswerComment, "display:inline;", Question.QuestionDS, Question.QuestionAnswerItemList(0).QuestionAnswerCommentFL))
            Case "PCT"
                sForm.Append(GetPercentInput(SurveyResponseItemBL.GetQuestionName(SurveyResponseID, SequenceNumber, Question), SurveyResponseItemBL.GetQuestionName(SurveyResponseID, SequenceNumber, Question), CStr(curSurveyResponseAnswer.AnswerQuantity), "display:inline;"))
            Case "DT"
                sForm.Append(GetDateInput(SurveyResponseItemBL.GetQuestionName(SurveyResponseID, SequenceNumber, Question), SurveyResponseItemBL.GetQuestionName(SurveyResponseID, SequenceNumber, Question), GetDateString(curSurveyResponseAnswer.AnswerDate), "display:inline;"))
            Case "CUR"
                sForm.Append(GetCurrencyInput(SurveyResponseItemBL.GetQuestionName(SurveyResponseID, SequenceNumber, Question), SurveyResponseItemBL.GetQuestionName(SurveyResponseID, SequenceNumber, Question), CStr(curSurveyResponseAnswer.AnswerQuantity), "display:inline;"))
            Case Else
                Select Case curSurveyResponseAnswer.AnswerType
                    Case "Quantity"
                        sForm.Append(GetTextInput(SurveyResponseItemBL.GetQuestionName(SurveyResponseID, SequenceNumber, Question), SurveyResponseItemBL.GetQuestionName(SurveyResponseID, SequenceNumber, Question), CStr(curSurveyResponseAnswer.AnswerQuantity), "display:inline;"))
                    Case "Date"
                        sForm.Append(GetDateInput(SurveyResponseItemBL.GetQuestionName(SurveyResponseID, SequenceNumber, Question), SurveyResponseItemBL.GetQuestionName(SurveyResponseID, SequenceNumber, Question), CStr(curSurveyResponseAnswer.AnswerDate), "display:inline;"))
                    Case Else
                        sForm.Append(GetTextInput(SurveyResponseItemBL.GetQuestionName(SurveyResponseID, SequenceNumber, Question), SurveyResponseItemBL.GetQuestionName(SurveyResponseID, SequenceNumber, Question), curSurveyResponseAnswer.AnswerComment, "display:inline;"))
                End Select
        End Select
        If bAddDiv Then
            sForm.Append("</div>")
    ...
    End Function
    Public Shared Function GetQuestionAnswerReviewForm(ByRef ReviewStatusList As List(Of SurveyReviewStatusItem),
                                                       ByVal ReviewLevel As Integer,
                                                       ByRef CurrentResponse As SurveyResponseAnswerItem) As String
        Dim QuestionAnswerReview As New SurveyResponseAnswerReviewItem
        Dim sForm As New StringBuilder(String.Empty)
        sForm.Append(SurveyResponseItemBL.GetHiddenFormField(SurveyResponseItemBL.GetSurveyQuestionAnswerIDName(CurrentResponse.SurveyResponseID, CurrentResponse.SequenceNumber, CurrentResponse.QuestionID), CStr(CurrentResponse.SurveyAnswerID)))
        ...
        For Each myAnswerReview In CurrentResponse.AnswerReviewList
            If ReviewLevel = myAnswerReview.ReviewLevel Then
                ...
                sForm.Append(SurveyResponseItemBL.GetHiddenFormField(SurveyResponseItemBL.GetSurveyQuestionAnswerReviewIDName(CurrentResponse.SurveyResponseID, CurrentResponse.SequenceNumber, CurrentResponse.QuestionID), CStr(myAnswerReview.SurveyResponseAnswerReviewID)))
            End If
        Next

        For Each ReviewStatus As SurveyReviewStatusItem In ReviewStatusList
            If ReviewStatus.ReviewStatusID = QuestionAnswerReview.ReviewStatusID Then
                If ReviewStatus.ApprovedFL Then
                    sForm.Append(GetRadioButtonOptionalTextBoxItem(SurveyResponseItemBL.GetQuestionName(CurrentResponse.SurveyResponseID, 1, CurrentResponse.QuestionID),
                                                           SurveyResponseItemBL.GetQuestionAnswerReviewItemID(CurrentResponse.SurveyResponseID, 1, CurrentResponse.QuestionID, ReviewStatus.ReviewStatusID),
                                                           CStr(ReviewStatus.ReviewStatusID),
                                                           SurveyResponseItemBL.GetQuestionAnswerComment(CurrentResponse.SurveyResponseID, 1, CurrentResponse.QuestionID),
                                                           True,
                                                           ReviewStatus.ReviewStatusDS,
                                                           ReviewStatus.CommentFL))
                Else
                    sForm.Append(GetRadioButtonTextBoxItem(SurveyResponseItemBL.GetQuestionName(CurrentResponse.SurveyResponseID, 1, CurrentResponse.QuestionID),
                                                           SurveyResponseItemBL.GetQuestionAnswerReviewItemID(CurrentResponse.SurveyResponseID, 1, CurrentResponse.QuestionID, ReviewStatus.ReviewStatusID),
                                                           CStr(ReviewStatus.ReviewStatusID),
                                                           SurveyResponseItemBL.GetQuestionAnswerComment(CurrentResponse.SurveyResponseID, 1, CurrentResponse.QuestionID),
                                                           True,
        ...
        Next
        sForm.Append(GetMemoInput(SurveyResponseItemBL.GetQuestionAnswerComment(CurrentResponse.SurveyResponseID, 1, CurrentResponse.QuestionID),
                                  SurveyResponseItemBL.GetQuestionAnswerComment(CurrentResponse.SurveyResponseID, 1, CurrentResponse.QuestionID),
    ...
    Private Function GetDropDownListQuestionHTML(ByRef bShowComment As Boolean) As String
        ...
        sbReturn.Append(String.Format("<div class=""styled-select""><select title=""You must select an answer"" tabindex=""{2}"" class=""required"" name=""{1}"" id=""{0}"" >",
                                      SurveyResponseItemBL.GetQuestionName(SurveyResponseID, SequenceNumber, Question),
                                      SurveyResponseItemBL.GetQuestionName(SurveyResponseID, SequenceNumber, Question), TabIndex))

        sbReturn.Append(GetDropDownListItem(String.Empty,
                                            SurveyResponseItemBL.GetQuestionAnswerItemID(SurveyResponseID, SequenceNumber, Question, New QuestionAnswerItem),
                                            String.Empty,
                                            SurveyResponseItemBL.GetQuestionAnswerComment(SurveyResponseID, SequenceNumber, Question),
                                            True,
                                            String.Empty,
                                            False))

        For Each qAnswer As QuestionAnswerItem In Question.QuestionAnswerItemList
            If curSurveyResponseAnswer.QuestionAnswerID = qAnswer.QuestionAnswerID Then
                ' bShowComment = qAnswer.QuestionAnswerCommentFL
                sbReturn.Append(GetDropDownListItem(SurveyResponseItemBL.GetQuestionName(SurveyResponseID, SequenceNumber, Question),
                                                       SurveyResponseItemBL.GetQuestionAnswerItemID(SurveyResponseID, SequenceNumber, Question, qAnswer),
            ...
            Else
                sbReturn.Append(GetDropDownListItem(SurveyResponseItemBL.GetQuestionName(SurveyResponseID, SequenceNumber, Question), _
                                                    SurveyResponseItemBL.GetQuestionAnswerItemID(SurveyResponseID, SequenceNumber, Question, qAnswer), _
                                                    CStr(qAnswer.QuestionAnswerID), _
                                                    SurveyResponseItemBL.GetQuestionAnswerComment(SurveyResponseID, SequenceNumber, Question), _
                                                    False, _
        ...
        If Question.CommentFL Then
            sbReturn.Append(GetMemoInput(SurveyResponseItemBL.GetQuestionAnswerComment(SurveyResponseID, SequenceNumber, Question),
                                         SurveyResponseItemBL.GetQuestionAnswerComment(SurveyResponseID, SequenceNumber, Question),
    ...
    Private Function GetCheckBoxListQuestionHTML(ByRef bShowComment As Boolean) As String
        ...
        For Each qAnswer As QuestionAnswerItem In Question.QuestionAnswerItemList
            ...
            If IsCurrentReponse(qAnswer.QuestionAnswerID) Then
                bShowComment = qAnswer.QuestionAnswerCommentFL
                sbReturn.Append(GetCheckBoxListItem(SurveyResponseItemBL.GetQuestionName(SurveyResponseID, SequenceNumber, Question),
                                                       SurveyResponseItemBL.GetQuestionAnswerItemID(SurveyResponseID, SequenceNumber, Question, qAnswer),
                                                       CStr(qAnswer.QuestionAnswerID),
                                                       SurveyResponseItemBL.GetQuestionAnswerComment(SurveyResponseID, SequenceNumber, Question),
                                                       True,
                ...
                sbReturn.Append(String.Format("{0}", vbCrLf))
            Else
                sbReturn.Append(GetCheckBoxListItem(SurveyResponseItemBL.GetQuestionName(SurveyResponseID, SequenceNumber, Question), _
                                                    SurveyResponseItemBL.GetQuestionAnswerItemID(SurveyResponseID, SequenceNumber, Question, qAnswer), _
                                                    CStr(qAnswer.QuestionAnswerID), _
                                                    SurveyResponseItemBL.GetQuestionAnswerComment(SurveyResponseID, SequenceNumber, Question), _
                                                    False, _
    ...
    Private Function GetRadioButtonListQuestionHTML(ByRef bShowComment As Boolean) As String
        ...
        For Each qAnswer As QuestionAnswerItem In Question.QuestionAnswerItemList
            If curSurveyResponseAnswer.QuestionAnswerID = qAnswer.QuestionAnswerID Then
                bShowComment = qAnswer.QuestionAnswerCommentFL
                sbReturn.Append(GetRadioButtonTextBoxItem(SurveyResponseItemBL.GetQuestionName(SurveyResponseID, SequenceNumber, Question),
                                                          SurveyResponseItemBL.GetQuestionAnswerItemID(SurveyResponseID, SequenceNumber, Question, qAnswer),
                                                          CStr(qAnswer.QuestionAnswerID),
                                                          SurveyResponseItemBL.GetQuestionAnswerComment(SurveyResponseID, SequenceNumber, Question),
                                                          True,
        ...
        If bShowComment Then
            sbReturn.Append(GetMemoInput(SurveyResponseItemBL.GetQuestionAnswerComment(SurveyResponseID, SequenceNumber, Question),
                                         ...
                                         False))
        Else
            sbReturn.Append(GetMemoInput(SurveyResponseItemBL.GetQuestionAnswerComment(SurveyResponseID,
                                                                                       SequenceNumber,
                                                                                       Question),
                                         SurveyResponseItemBL.GetQuestionAnswerComment(SurveyResponseID,
                                                                                       SequenceNumber,
                                                                                       Question),
                                         curSurveyResponseAnswer.AnswerComment,
                                         "display:none;",
    ...
    Private Function GetDateInput(ByVal Name As String, ByVal ID As String, ByVal CurrentValue As String, ByVal style As String) As String
        ...
        Catch ex As Exception
            ApplicationLogging.ErrorLog(ex.ToString, "SurveyResponseItemBL.GetDateInput")
        End Try
        Return sbReturn.ToString()
    End Function
