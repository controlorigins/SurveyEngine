<%@ Control Language="VB" AutoEventWireup="false" CodeFile="SurveyResponse.ascx.vb" Inherits="Co_Apps_SurveyApp_SurveyResponse" %>
        ...
        <div class="col-lg-12">
            <div class="panel panel-info">
                ...
                <div id="submitcancel" runat="server" class="panel-body">
                    <asp:LinkButton ValidationGroup="SurveyApp" ID="btn_Submit" runat="server" CssClass="btn btn-primary" Text="Save Response" OnClick="cmd_submit_Click"></asp:LinkButton>
