<%@ Page Language="VB" AutoEventWireup="false" CodeFile="demo.aspx.vb" Inherits="modules_demo" %>
...
<body>
    ...
    <div>
        ...
        <p>
        <a href="CookiesHandler.ashx?help">Show Handler Help</a>
        </p>

        <p>
        <a href="CookiesHandler.ashx?method=GreetMe&name=AlexCode">Greet me!</a>
        </p>
        
        <p>
        Greet this:<input type="text" id="txtGreetName" /><input type="button" value="Go" onclick="javascript: window.location.href = 'CookiesHandler.ashx?method=GreetMe&name=' + document.getElementById('txtGreetName').value" />
        </p>
		...
		<script type="text/javascript">
		    function AJAXSendComplextTypeArray() {
		        $.ajax({
		            ...
		            type: 'GET',
		            data: {
		                method: 'AJAXSendComplextTypeArray',
		                args: {
		                    items: [1, 2, 3],
		                    addresses: [
        ...
        <p>
			...
			<a href="CookiesHandler.ashx?method=GiveMeSomeHTML&text=DummyImput">Click Here</a>
		</p>
