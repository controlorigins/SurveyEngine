...
Public Class Co_Apps_SurveyAdmin_Controls_ApplicationItem
    Inherits SurveyUserControlBase
    Public myApplication As ApplicationItem
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        Dim ApplicationID = GetPageArgument("applicationid").Second
                ...
                Case "applicationview"
                    If ApplicationID > 0 Then
                        ...
                        With myApplication
                            ...
                            dtNavigation.TableHeader.DetailPath = "/Co_Apps/SurveyAdmin/navigator.aspx?action=applicationview&subaction=navigationview&navigatonid={0}"
                            ...
                            dtProperties.TableHeader.DetailPath = "/Co_Apps/SurveyAdmin/navigator.aspx?action=applicationview&subaction=propertyview&propertyid={0}"
    ...
    Protected Sub cmd_SaveApplication_Click(sender As Object, e As EventArgs)
        ...
        If AppUtility.GetDBInteger(hfApplicationID.Value, 0) < 0 Then
            SetPageArgument("applicationid", myApplication.ApplicationID)
        Else
            SetPageArgument("applicationid", 0)
        End If
    ...
    Protected Sub cmd_SaveUserAssignment_Click(sender As Object, e As EventArgs)
        ...
        If sReturn = String.Empty Then
            ClearPageArguments()
            SetPageArgument("applicationid", hfApplicationID.Value)
            SetPageArgument("action", "applicationview")
            LoadPage()
        Else
            MsgBox(sReturn)
