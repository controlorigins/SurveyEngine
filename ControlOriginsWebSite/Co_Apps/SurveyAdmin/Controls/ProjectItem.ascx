<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ProjectItem.ascx.vb" Inherits="Co_Apps_SurveyAdmin_Controls_ProjectItem" %>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="form-group">
                    <asp:Label ID="labeltbApplicationNM" runat="server" AssociatedControlID="tbApplicationNM">Project:</asp:Label>
