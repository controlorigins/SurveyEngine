...
Partial Class controls_ChartConfiguration
    ...
    Private myConfiguration As New DataGridVisualization.DataGridVisualization
    Protected Sub Page_Init(sender As Object, e As EventArgs) Handles Me.Init
        ...
        End If
    End Sub
    Public Function GetChartConfiguration() As DataGridVisualization.DataGridVisualization Implements Icontrols_ChartConfiguration.GetChartConfiguration
    ...
    Public Sub PutChartConfiguration(Configuration As DataGridVisualization.DataGridVisualization) Implements Icontrols_ChartConfiguration.PutChartConfiguration
