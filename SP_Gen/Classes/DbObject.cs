...
namespace NovinMedia.Data
{
    ...
    public class DbObject
    {
        ...
        public DataSet RunProcedure(string storedProcName, IDataParameter[] parameters, string tableName)
        {
            ...
            Connection.Open();
            SqlDataAdapter sqlDA = new SqlDataAdapter() { SelectCommand = BuildQueryCommand(storedProcName, parameters) };
        ...
        {
            Connection.Open();
            SqlDataAdapter sqlDA = new SqlDataAdapter() { SelectCommand = BuildIntCommand(storedProcName, parameters) };
            sqlDA.Fill(dataSet, tableName);
            Connection.Close();
        }
